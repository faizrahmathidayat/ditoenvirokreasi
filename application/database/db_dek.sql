...
--
-- Table structure for table `dek_layanan`
--

DROP TABLE IF EXISTS `dek_layanan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dek_layanan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_kategori_layanan` int(11) DEFAULT NULL,
  `judul` varchar(255) DEFAULT NULL,
  `deskripsi` text DEFAULT NULL,
  `layanan_body` longtext DEFAULT NULL,
...
--
-- Dumping data for table `dek_layanan`
--

LOCK TABLES `dek_layanan` WRITE;
/*!40000 ALTER TABLE `dek_layanan` DISABLE KEYS */;
/*!40000 ALTER TABLE `dek_layanan` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `dek_settings` VALUES (1,'maintenance_mode',1);
...
-- Dump completed on 2023-05-28 19:54:49
